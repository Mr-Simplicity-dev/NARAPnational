...
// Temporary debug - add this at the top of your script
...
async function loadMembersSimple(type) {
  try {
    ...
    const tbody = document.getElementById(`list-members-${type}`);
    if (tbody) {
      tbody.innerHTML = '<tr><td colspan="6" class="text-center text-danger py-4">Failed to load members: ' + err.message + '</td></tr>';
    }
  }
}
